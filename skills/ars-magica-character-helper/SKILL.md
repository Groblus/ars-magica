...
4. Resolve the installed `ars-magica-corpus-navigator` skill directory, then search structured data before prose:
   - `<navigator>/resources/core-data.json` buckets: `virtues`, `flaws`, `abilities`, `spells`.
   - `python3 <navigator>/scripts/search.py "character creation"`.
